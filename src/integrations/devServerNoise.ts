...
export function isLocalDevHost(host: string | undefined): boolean {
    if (!host) {
        return false;
    }
...
export interface IdePreviewHeaders {
    secFetchSite?: string;
    secFetchMode?: string;
    origin?: string;
    host?: string;
 ...
 */
export function shouldBypassSecFetchForIdePreview(headers: IdePreviewHeaders): boolean {
 ...
 */
export function shouldShortCircuitDevtoolsProbe(pathname: string): boolean {
 ...
 */
export function demoPublicDirRedirect(pathname: string): string | null {
 ...
 */
export function rewritePublicDirIndexRequest(pathname: string): string | null {
    if (pathname === '/demo/') {
...
const DEMO_STATIC_TYPES: Record<string, string> = {
 ...
 */
export function demoPublicFileRel(pathname: string): string | null {
...
export function publicFontRel(pathname: string): string | null {
 ...
 */
export function demoStaleFontRel(pathname: string): string | null {
    const clean = pathname.split('?')[0];
...
function sendDemoPublicFile(publicDir: string, rel: string, res: ServerResponse): void {
...
function sendPublicDirFile(publicDir: string, rel: string, res: ServerResponse): void {
 ...
 */
export function devServerNoisePlugin(): Plugin {
    return {
