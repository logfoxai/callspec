...
Whitelabel via flat **`meta`** fields (`title`, `intro`, `website`, `logo`, `theme`, `navbarLinks`, `footer`, `favicon`, `sdkInstall`, `authHint`, `mcpInstructions`). Guide: [Docs UI](../docs-ui.md) · [Branding](../docs-ui-branding.md).
