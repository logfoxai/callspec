...
| Goal | How |
|------|-----|
| Try an RPC | Open a route → fill the form → run. Same validation and error codes as production HTTP. |
| See the contract | Input/output schemas and declared errors on each route detail page. |
