---
title: Docs UI
description: White-label explorer for your Callspec routes — try methods, inspect schemas, and copy MCP config.
---
...
- **Explorer** — `{mount}/docs` — try routes, inspect schemas and errors; home page MCP connect panel
- **`callspec.json`** — `{mount}/callspec.json` — contract for `npx callspec` ([SDK generation](./sdk-generation.md))
- **`openapi.json`** — `{mount}/openapi.json` — OpenAPI export ([OpenAPI](./openapi.md))
